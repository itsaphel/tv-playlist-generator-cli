...
public class Spotify {
    ...
    public Paging<Track> searchForSong(String songTitle) throws IOException, ParseException, SpotifyWebApiException {
        return spotifyApi.searchTracks(songTitle)
          .build()
          .execute();
    }
    ...
    public Playlist createPlaylist(String name) throws IOException, SpotifyWebApiException, ParseException {
        ...
        return spotifyApi.createPlaylist(this.userId,
          ...
          .public_(false)
          .description(
            "Playlist generated using tv-playlist-generator (https://tvpg.indices.io).")
            .build()
            .execute();
    }
    ...
    public void addTracksToPlaylist(Playlist playlist, List<String> trackIds)
      throws IOException, SpotifyWebApiException, ParseException {
        ...
        int batchSize = 50;
        int numberBatchesRequired = (int) Math.ceil((double) trackIds.size() / batchSize);
